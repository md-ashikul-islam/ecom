                                ...
                                <ul class="contact-lines"> 
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">Phone: (+880) 1715547255</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-letter"></i>
                                            <b class="desc">Email:  cholokini@gmail.com</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-clock"></i>
                                            <b class="desc">Hours: 7 Days a week from 10:00 am to 2:00 am</b>
                                        </p>
                                    </li>
                                </ul>
                            </div>
